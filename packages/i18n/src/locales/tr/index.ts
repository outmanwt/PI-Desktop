...
sklm: {
    ...
    settingsImportMemoryKeys: "Bellek",
    importMemoryDesc: "WorkBuddy Markdown belleğini seçilen projeye aktarın. Mevcut girdiler korunur ve yinelenen içerikler atlanır.",
    importMemoryTarget: "Hedef proje: {{path}}",
    importMemoryFound: "{{count}} bellek dosyası bulundu",
    importMemoryResult: "Bellek aktarımı tamamlandı: {{imported}} aktarıldı, {{skipped}} atlandı, {{failed}} başarısız",
