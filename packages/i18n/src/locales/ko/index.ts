...
sklm: {
    ...
    settingsImportMemoryKeys: "메모리",
    importMemoryDesc: "WorkBuddy Markdown 메모리를 선택한 프로젝트로 가져옵니다. 기존 항목은 보존되고 중복 내용은 건너뜁니다.",
    importMemoryTarget: "대상 프로젝트: {{path}}",
    importMemoryFound: "메모리 파일 {{count}}개 발견",
    importMemoryResult: "메모리 가져오기 완료: {{imported}}개 가져옴, {{skipped}}개 건너뜀, {{failed}}개 실패",
