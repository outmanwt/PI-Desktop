...
sklm: {
    ...
    importMemoryDesc: "Importiere WorkBuddy-Markdown-Memory in das ausgewählte Projekt. Vorhandene Einträge bleiben erhalten, doppelte Inhalte werden übersprungen.",
    importMemoryTarget: "Zielprojekt: {{path}}",
    importMemoryFound: "{{count}} Memory-Dateien gefunden",
    importMemoryResult: "Memory-Import abgeschlossen: {{imported}} importiert, {{skipped}} übersprungen, {{failed}} fehlgeschlagen",
    ...
    "remoteHosts": {
      "sshProfiles": "SSH-Konfiguration",
      "scanningSsh": "Wird gescannt…",
      "scanSsh": "SSH-Konfiguration scannen",
      "sshConnect": "Installieren und verbinden",
      "noSshProfiles": "Keine SSH-Host-Aliase gefunden.",
      "title": "Remote-Hosts",
