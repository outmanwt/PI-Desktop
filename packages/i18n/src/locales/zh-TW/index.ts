...
sklm: {
    ...
    settingsImportMemoryKeys: "記憶",
    importMemoryDesc: "將 WorkBuddy 的 Markdown 記憶匯入目前專案。既有記憶會保留，重複內容會跳過。",
    importMemoryTarget: "目標專案：{{path}}",
    importMemoryFound: "找到 {{count}} 個記憶檔案",
    importMemoryResult: "記憶匯入完成：成功 {{imported}}、跳過 {{skipped}}、失敗 {{failed}}",
