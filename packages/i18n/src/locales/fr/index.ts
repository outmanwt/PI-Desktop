...
sklm: {
    ...
    settingsImportMemoryKeys: "Mémoire",
    importMemoryDesc: "Importez la mémoire Markdown de WorkBuddy dans le projet sélectionné. Les entrées existantes sont conservées et les contenus en double sont ignorés.",
    importMemoryTarget: "Projet cible : {{path}}",
    importMemoryFound: "{{count}} fichiers de mémoire trouvés",
    importMemoryResult: "Import mémoire terminé : {{imported}} importés, {{skipped}} ignorés, {{failed}} échoués",
    importMemorySourceWorkBuddy: "WorkBuddy",
    importMemory: "Mémoire",
