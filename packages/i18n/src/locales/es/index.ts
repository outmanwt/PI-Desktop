...
sklm: {
    ...
    settingsImportMemoryKeys: "Memoria",
    importMemoryDesc: "Importa la memoria Markdown de WorkBuddy en el proyecto seleccionado. Las entradas existentes se conservan y el contenido duplicado se omite.",
    importMemoryTarget: "Proyecto de destino: {{path}}",
    importMemoryFound: "Se encontraron {{count}} archivos de memoria",
    importMemoryResult: "Importación de memoria completada: {{imported}} importadas, {{skipped}} omitidas, {{failed}} fallidas",
    importMemorySourceWorkBuddy: "WorkBuddy",
    importMemory: "Memoria",
    ...
    "remoteHosts": {
      "sshProfiles": "Configuración SSH",
      "scanningSsh": "Escaneando…",
      "scanSsh": "Escanear configuración SSH",
      "sshConnect": "Instalar y conectar",
      "noSshProfiles": "No se encontraron alias de hosts SSH.",
      "title": "Hosts remotos",
