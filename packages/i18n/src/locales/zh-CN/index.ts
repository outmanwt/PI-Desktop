...
sklm: {
    ...
    settingsImportMemoryKeys: "记忆",
    importMemoryDesc: "将 WorkBuddy 的 Markdown 记忆导入当前项目。已有记忆会保留，重复内容会跳过。",
    importMemoryTarget: "目标项目：{{path}}",
    importMemoryFound: "发现 {{count}} 个记忆文件",
    importMemoryResult: "记忆导入完成：成功 {{imported}}，跳过 {{skipped}}，失败 {{failed}}",
